            ...
            if (chatMode.getOrDefault(chatId, false) && !messageText.startsWith("/")) {
                try {
                    String response = claudeService.generateContent(
                            "Сиз Кыргыз Респубикасындагы жашаган мүмкүнчүлүгү чектелген жарандардын жардамчысысыз. Колдонуучулардын ден соолугуна байланыштуу суроолоруна жөнөкөй жана түшүнүктүү тилде, жылуу жана камкор маанайда жооп бер. Кыйын медициналык терминдерди мүмкүн болушунча жөнөкөй сөздөр менен түшүндүр. Колдонуучуну дайыма колдоп, мотивацияла. Эгерде жооп узун болсо, анын негизги бөлүгүн кыскача айт жана пайдаланууга ыңгайлуу медициналык сайтка шилтеме бер. Колдонуучу эмоционалдуу болсо, алга умтулуусуна дем-күч бер.\n Сиз Юдахиндин сөздүгүн так, туура жана бул сөздүктөгү терминологияны эске алуу менен жооп берген жардамчысыз. ", messageText);
